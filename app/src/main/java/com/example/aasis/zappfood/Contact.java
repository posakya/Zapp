...
public class Contact extends Fragment {
    private View myView;
    private TextView txt_zappfood,txt_phone,txt_mobile;
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_zappfood=(TextView) myView.findViewById(R.id.txt_zappfood);
        txt_mobile=(TextView) myView.findViewById(R.id.txt_mobile);
        txt_phone=(TextView) myView.findViewById(R.id.txt_phone);
